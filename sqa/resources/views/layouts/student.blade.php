...
<body>
    ...
    <div id="sidebar" class="sidebar">
        ...
        <nav class="nav flex-column mt-3">
            <a href="{{ route('student.dashboard') }}" class="nav-link"><i class="bi bi-house-door"></i><span class="nav-text">Dashboard</span></a>
            <a href="{{ route('student.profile') }}" class="nav-link"><i class="bi bi-people"></i><span class="nav-text">Profile</span></a>
