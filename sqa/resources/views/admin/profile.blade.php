                                ...
                                <form action="{{ route('admin.profile.update') }}" method="POST">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="identification_number" class="form-control"
                                                value="{{ old('identification_number', $admin->identification_number) }}">
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="email" class="form-control" value="{{ $admin->user->email }}"
                                                readonly>
                                        </div>

                                        <div class="col-md-6">
                                            <label class="form-label fw-semibold">Role</label>
                                            <input type="text" class="form-control" value="{{ $admin->role->name }}"
                                                readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="admin_id" class="form-control"
                                            value="{{ old('admin_id', $admin->admin_id) }}" readonly>
                                    </div>
